<%@ Page Title="Squat" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Squat.aspx.cs" Inherits="Assignment1.Management.Squat" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPBody" runat="server">
    <div class="container bg-light rounded py-3">
        <div class="row">
            <div class="col-md-6 col-sm-12 my-3">
                ...
                <h2 class="pb-3 pt-0 mt-0 text-center">for the Squat:</h2>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md">
                                <select name="Exercise" id="Exercise" class="form-control" required>
                                    ...
                                    <option value="bench" disabled>Bench Press</option>
        ...
        <div class="container bg-light rounded my-3" visible="false" id="oneRepMaxContainer" runat="server">
            <div class="row">
                <div class="col-md-6 col-sm-12 py-3">
                    <h5>
                        We estimate that your one-rep max is
                ...
                <div class="col-md-6 col-sm-12  py-3">
                    ...
                    <asp:Repeater ID="SquatStandardsTable" runat="server" ItemType="Assignment1.Models.MaleSquatStandardKg">
                        <HeaderTemplate>
                        ...
                        <ItemTemplate>
                            <asp:Panel runat="server" class="row border-bottom" Visible="<%# ((Item.Bodyweight == (int)(Math.Round(currentUser.bodyweight / 5.0) * 5)) | (Item.Bodyweight == (int)(Math.Round(currentUser.bodyweight / 10.0) * 10))) %>">
                                <div class="col-md mx-1 my-1 standard border-right border-dark">

                                    <h6 class="text-center my-2"><%# Item.Bodyweight %></h6>
                                </div>
                                <div class="col-md mx-1 my-1 border-right standard">
                                    <h6 class="text-center my-2"><%# FormatStandard(Item.Beginner, currentUser) %></h6>
                                </div>
                                <div class="col-md mx-1 my-1 border-right standard">
                                    <h6 class="text-center my-2"><%# FormatStandard(Item.Novice, currentUser) %></h6>
                                </div>
                                <div class="col-md mx-1 my-1 border-right standard">
                                    <h6 class="text-center my-2"><%# FormatStandard(Item.Intermediate, currentUser) %></h6>
                                </div>
                                <div class="col-md mx-1 my-1 border-right standard">
                                    <h6 class="text-center my-2"><%# FormatStandard(Item.Advanced, currentUser) %></h6>
                                </div>
                                <div class="col-md mx-1 my-1 border-right standard">
                                    <h6 class="text-center my-2"><%# FormatStandard(Item.Elite, currentUser) %></h6>
                                </div>
                            </asp:Panel>
                        </ItemTemplate>
    ...
    <script>
        document.getElementById("squatNav").classList.add("active");
    </script>
    <script>
